...
//And usually this will want to do next/router but the newest version is in next/navigation
...
const LoginPage = () => {
  ...
  //Make sure that you follow the instructions from the video timing 50 mins to do 
  //the google cloud project setup and authentication setup
